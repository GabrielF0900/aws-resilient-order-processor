...
| Aspecto | Descrição |
|--------|----------|
| **O que é** | Orquestrador serverless de processamento de pedidos com desacoplamento completo via filas |
| **Problema Resolvido** | Eliminar custos fixos de infra e garantir escalabilidade automática sob picos de demanda |
| **Stack & AWS** | Node.js • AWS Lambda • Amazon SQS • S3 • Step Functions • EventBridge |
| **Resultado Prático** | Custo zero em ociosidade + escalabilidade automática + processamento resiliente |
